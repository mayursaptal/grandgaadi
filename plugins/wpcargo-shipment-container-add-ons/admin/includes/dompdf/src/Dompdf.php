...
use WPCSC_HTML5_Tokenizer;
use WPCSC_HTML5_TreeBuilder;
    ...
    */
    ...
    public function __construct($options = null)
    {
        ...
        if (isset($options) && $options instanceof Options) {
            ...
            $this->setOptions(new WPCSC_Options($options));
        } else {
            $this->setOptions(new WPCSC_Options());
        }
    ...
    public function loadHtml($str, $encoding = 'UTF-8')
    {
        ...
        if ($this->options->isHtml5ParserEnabled() && class_exists("WPCSC_HTML5_Tokenizer")) {
            $tokenizer = new WPCSC_HTML5_Tokenizer($str);
            $tokenizer->parse();
            $doc = $tokenizer->save();
     ...
     * @return $this
     */
    public function setOptions(WPCSC_Options $options)
    {
