...
<form class="formargin" id="formargin" method="get" enctype="multipart/form-data">
    ...
    <div class="col-6 p-0">
        ...
        <button onclick="imprimir()" id="formdata" class="btn btn-primary btn-sm ml-2">Print Table</button>
...
<div>
    ...
    <div id="printthistable" class="tablediv ">
...
<script type="text/javascript">
    function imprimir() {
        ...
        var divContents = document.getElementById("printthistable").innerHTML;
